...
test_e %>% 
  ...
  scale_fill_manual(values = bran_palette, limits=c("male","female","neutral")) + 
  scale_alpha(range=c(0.4,1)) + 
...
```{r}
ggsave("prod-3x2x3.png", width=7,height=5,path='/Users/branpap/Desktop/gender_ideology/talks_and_papers/qp_paper/figures'2)
```
