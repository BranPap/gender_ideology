---
title: "Papineau QP1 - Supplementary Materials"
author: "B. Papineau"
date: "Autumn 2021"
output:
  html_document:
...
This document contains supplementary material related to my first Qualifying Paper towards the PhD in Linguistics at Stanford University. This document is a work in progress, but will contain the methods and results of my norming study on the gendered interpretations of gender-marked role titles in English, as well as the perception study/ies not included in the final write-up, but which were carried out as a part of the investigation.\par 
The document proceeds as follows: I begin with reporting on the methods and results of the studies in turn, followed by a discussion regarding the decision not to include these particular experiments in the final write up. 
